...
public class MuPDFReflowView extends WebView implements MuPDFView {
	...
	public MuPDFReflowView(Context c, MuPDFCore core, Point parentSize) {
		...
		setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView view, String url) {
				loadUrl("javascript:document.style.zoom=\""+(int)(mScale*100)+"%\"");
				...
				//String javascript="javascript:document.getElementsByName('viewport')[0].setAttribute('content', 'initial-scale=1.0,target-densitydpi=device-dpi');";
	...
	public void setScale(float scale) {
		mScale = scale;
		//avoid errors in some android versions.
		//	loadUrl("javascript:document.body.style.zoom=\""+mScale+"\"");
